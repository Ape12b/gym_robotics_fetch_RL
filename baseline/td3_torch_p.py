...
class Agent():
    ...
    def learn(self):
        ...
        done = T.tensor(done, dtype=T.bool, device=self.actor.device).to(self.critic_1.device)
        ...
        target_actions = T.clamp(target_actions, min=self.min_action, max=self.max_action)
